...
playGame.prototype = {
     preload: function(){
          ...
          game.load.image("square", "juegos/cubo/square.png");
          game.load.image("mad", "juegos/cubo/mad_2.png");  
          game.load.image("ground", "juegos/cubo/ground.png"); 
          game.load.image("hero", "juegos/cubo/hero.png"); 
          game.load.spritesheet("caras", "juegos/cubo/caras.png",80,80,15); 
     ...
     create: function(){ 
          ...
          for(var i = 0; i < game.width / squareSize + 2; i++){
               ...
               var square = game.add.sprite(i * squareSize, game.height / 3 * 2, "ground");
          ...
          // adding the hero
          this.hero = game.add.sprite(startingSquare * squareSize, game.height / 3 * 2 - (squareSize-3), "hero");
          
          // setting the anchor on its center
          this.hero.anchor.set(0.5);

          this.cara = this.add.sprite(startingSquare * squareSize, game.height / 3 * 2 - (squareSize-3), 'caras',7);
          ...
          game.physics.enable(this.cara, Phaser.Physics.ARCADE);
     ...
     moveHero: function(){
          ...
          if(this.hero.canMove){
               ...
               // tween to rotate and move the cara
                var caraTween = game.add.tween(this.cara).to({
                    angle: this.cara.angle + 30,                    
               }, moveTime, Phaser.Easing.Circular.Out, true, 0,0, true);
     ...
     addEnemy: function(){
          ...
          var enemy = game.add.sprite(this.terrainGroup.getChildAt(0).x, 20, "mad");
          ...
          game.add.tween(enemy).to({
               y: this.game.height / 3 * 2 - squareSize,
